...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            Toast.makeText(this, "You have not entered anything for search",Toast.LENGTH_SHORT).show();
            return;
        }
...
return new AsyncTaskLoader<String>(this){
    ...
    public String loadInBackground() {
        ...
        if (!TextUtils.isEmpty(searchQueryUrlString)&& searchQueryUrlString != null) {
            String _searchUrl = bundle.getString(SEARCH_QUERY_URL_EXTRA);

            String githubSearchResults = null;
            try {
                URL searchUrl = new URL(_searchUrl);

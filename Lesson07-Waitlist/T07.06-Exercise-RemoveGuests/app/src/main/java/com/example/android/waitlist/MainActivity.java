...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean removeGuest(long id){
        String whereClause = WaitlistContract.WaitlistEntry._ID+" = ?";
        String[] whereArgs = {String.valueOf(id)};
        int deleteGuest =  mDb.delete(WaitlistContract.WaitlistEntry.TABLE_NAME,whereClause ,whereArgs);
        return deleteGuest>0;
    }
